...
const LoadingScreen = () => {
  ...
  useEffect(() => {
    // Progress bar animation - Complete in 4 seconds
    const progressInterval = setInterval(() => {
      setProgress(prev => {
        ...
        return prev + 1.5 // Slower progress to fit 4 seconds
      })
    }, 60)

    // Typing effect - Faster cycling for 4 seconds
