...
export default function PsychiatryPage({ 
  ...
  console.log("PsychiatryPage component is rendering")
  ...
  const doctors = [
    ...
    },
    {
      ...
      specialization: "Psychiatrist",
      experience: "22 YEARS",
      degrees: "MBBS, MD(PSYCHIATRY), FRCP...",
      clinic: "Mental Health Institute",
      location: "Delhi",
      fees: 2200,
    ...
    },
    {
      ...
      experience: "20 YEARS",
      degrees: "MBBS, MD(PSYCHIATRY), FRCP...",
      clinic: "Mental Health Solutions",
      location: "Hyderabad",
      fees: 2000,
    ...
    },
    {
      ...
      experience: "28 YEARS",
      degrees: "MBBS, MD(PSYCHIATRY), DM...",
      clinic: "Psychiatry & Mental Health Hospital",
      location: "Chennai",
      fees: 3200,
    ...
    <div className="flex flex-col min-h-screen bg-blue-50">
      ...
      <main className="flex-1 p-4 space-y-6 overflow-auto pb-24">
        ...
        <h2 className="text-xl font-bold text-gray-800">
          Consult Psychiatrists Online - Mental Health Specialists ({filteredDoctors.length} doctors)
        </h2>
