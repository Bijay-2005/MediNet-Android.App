...
export default function CardiologyPage({ 
  ...
  const doctors = [
    {
      id: "1",
      name: "S B Bhattacharyya",
      specialization: "Cardiologist",
      experience: "22 YEARS",
      degrees: "MBBS, MD(GENERAL MEDICINE), D...",
      clinic: "Gariaheart Clinic",
      location: "Kolkata",
      fees: 1875,
    ...
    {
      id: "2",
      name: "Jayarajah Mariappan",
      specialization: "Cardiologist",
      experience: "35 YEARS",
      degrees: "MBBS, MD(GEN MEDICINE), D...",
      clinic: "Chennai Hospital",
      location: "Chennai",
      fees: 700,
    ...
    {
      id: "3",
      name: "Sumanta Chatterjee",
      specialization: "Cardiologist",
      experience: "13 YEARS",
      degrees: "MBBS, MD GENERAL MEDICINE...",
      clinic: "HealthYou Speciality Clinic & Diagnostics",
      location: "Kolkata",
      fees: 1100,
      onlineConsultAvailability: "Available Today",
      visitDoctorAvailability: "Available Tomorrow",
    ...
    },
    {
      ...
      experience: "13 YEARS",
      degrees: "MBBS, MD GENERAL MEDICINE...",
      clinic: "Apollo Clinic_Opposite South City Mall",
      location: "Kolkata",
      fees: 1000,
    ...
    },
    {
      ...
      specialization: "Cardiologist",
      experience: "15 YEARS",
      degrees: "MBBS, PGDM, FFM",
      clinic: "PRESTIGE SHANTHINIKETAN - SOCIETY CLI",
      location: "Bengaluru",
      fees: 400,
    ...
    <div className="flex flex-col min-h-screen bg-blue-50">
      ...
      <main className="flex-1 p-4 space-y-6 overflow-auto pb-24">
        ...
        <h2 className="text-xl font-bold text-gray-800">
          Consult Cardiologists Online - Heart Specialists ({filteredDoctors.length} doctors)
        </h2>
