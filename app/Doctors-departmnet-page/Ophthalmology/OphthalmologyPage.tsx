...
export default function OphthalmologyPage({ 
  ...
  console.log("OphthalmologyPage component is rendering")
  ...
  const doctors = [
    ...
    },
    {
      ...
      specialization: "Ophthalmologist",
      experience: "18 YEARS",
      degrees: "MBBS, MS(OPHTHALMOLOGY), DM...",
    ...
    <div className="flex flex-col min-h-screen bg-blue-50">
      ...
      <main className="flex-1 p-4 space-y-6 overflow-auto pb-24">
        ...
        <h2 className="text-xl font-bold text-gray-800">
          Consult Ophthalmologists Online - Eye Specialists ({filteredDoctors.length} doctors)
        </h2>
