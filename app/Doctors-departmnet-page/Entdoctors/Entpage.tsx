...
export default function EntPage({ 
  ...
  console.log("EntPage component is rendering"); // Debug log
  ...
  const doctors = [
    {
      ...
      experience: "22 YEARS",
      degrees: "MBBS, MD(ENT), D...",
      clinic: "Modern ENT Clinic",
      location: "Kolkata",
      fees: 1875,
    ...
    <div className="flex flex-col min-h-screen bg-blue-50">
      ...
      <main className="flex-1 p-4 space-y-6 overflow-auto pb-24">
        ...
        <h2 className="text-xl font-bold text-gray-800">
              Consult ENT Specialists Online - ENT Specialists ({filteredDoctors.length} doctors)
        </h2>
